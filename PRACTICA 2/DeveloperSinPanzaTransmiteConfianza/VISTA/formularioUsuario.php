...
<html>
    ...
    <body>
        ...
        <form action="/DeveloperSinPanzaTransmiteConfianza/CONTROLADOR/redirigir.php" method="get">

            <p><label for="Peso">Peso (kg):</label>
                <input type="number" name="Peso" id="Peso" required></p>

            <p><label for="Altura">Altura (cm):</label>
                <input type="number" name="Altura" id="Altura" required></p>

            <p><label for="FechaDeNacimiento">Fecha de Nacimiento:</label>
                <input type="date" name="FechaDeNacimiento" id="FechaDeNacimiento" required></p>
